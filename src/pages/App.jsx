...
import { getRecipes } from "../utils/pocketbase";
...
function App() {
  ...
  useEffect(() => {
    ...
    getRecipes(4).then((data) => setRecipes(data));
  }, []);
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-primary">
        <header className="flex flex-col items-center justify-center px-10 py-28 text-[#211410]">
          ...
          <a
            href="recipes"
            className="transform cursor-pointer rounded-lg bg-accent px-6 py-3 text-xl font-bold text-primary shadow-lg transition-transform duration-300 hover:scale-105 hover:bg-[#ad3b31]"
          >
            What do I eat Today? 🪄
          </a>
        </header>
